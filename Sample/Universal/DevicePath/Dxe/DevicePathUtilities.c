...
--*/
{
  ...
  //
  NewDevicePath = EfiLibAllocateCopyPool (Size, (VOID *) DevicePath);
...
--*/
{
  ...
  NewDevicePath = EfiLibAllocateCopyPool (Size, (VOID *) Src1);
  ...
  if (NewDevicePath != NULL) {
    ...
    EfiCopyMem (SecondDevicePath, (VOID *) Src2, Size2);
  }
...
--*/
{
  ...
  Temp        = EfiLibAllocateCopyPool (NodeLength + sizeof (EFI_DEVICE_PATH_PROTOCOL), (VOID *) DeviceNode);
  if (Temp == NULL) {
    return NULL;
  }
...
--*/
{
  ...
  Ptr           = EfiLibAllocateCopyPool (SrcSize + InstanceSize, (VOID *) DevicePath);
  if (Ptr != NULL) {
    ...
    EfiCopyMem (DevPath, (VOID *) DevicePathInstance, InstanceSize);
  }
...
--*/
{
  ...
  Node = (EFI_DEVICE_PATH_PROTOCOL *) EfiLibAllocateZeroPool ((UINTN) NodeLength);
  if (Node != NULL) {
    Node->Type    = NodeType;
