...
--*/
{
  ...
  DevPathNodeLen  = sizeof (ISCSI_DEVICE_PATH) + EfiAsciiStrLen (ConfigNvData->TargetName) + 1;
  ...
  EfiAsciiStrCpy ((CHAR8 *) Node + sizeof (ISCSI_DEVICE_PATH), ConfigNvData->TargetName);
...
--*/
{
  ...
  if (EfiAsciiStrCmp (ConfigNvData->TargetName, (CHAR8 *) DevicePath + sizeof (ISCSI_DEVICE_PATH)) != 0) {
    return EFI_UNSUPPORTED;
  }
