...
Arguments:
  ...
  CachedPacket  - GC_NOTO: add argument description
...
Arguments:
  ...
  Type    - GC_NOTO: add argument description
  Layer   - GC_NOTO: add argument description
  OptLen  - GC_NOTO: add argument description
...
Arguments:
  ...
  Dhcp4Option   - GC_NOTO: add argument description
  VendorOption  - GC_NOTO: add argument description
