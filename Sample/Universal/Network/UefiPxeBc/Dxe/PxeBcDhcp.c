...
Arguments:
  ...
  Dst - GC_NOTO: add argument description
  Src - GC_NOTO: add argument description
...
Arguments:
  ...
  OfferIndex  - GC_NOTO: add argument description
...
Arguments:
  ...
  CachedPacket  - Pointer to cached dhcp packet

Returns:

  TRUE  : Success to parse and validation
  FALSE : Fail to parse or validation
...
Arguments:
  ...
  Private - GC_NOTO: add argument description
  Index   - GC_NOTO: add argument description
...
Arguments:
  ...
  Private   - GC_NOTO: add argument description
  RcvdOffer - GC_NOTO: add argument description
...
Arguments:
  ...
  CurrentState  - GC_NOTO: add argument description
  Dhcp4Event    - GC_NOTO: add argument description
  Packet        - GC_NOTO: add argument description
  NewPacket     - GC_NOTO: add argument description

Returns:

  EFI_SUCCESS - GC_NOTO: Add description for return value
  EFI_ABORTED - GC_NOTO: Add description for return value
...
Arguments:
  ...
  Private         - GC_NOTO: add argument description
  OptList         - GC_NOTO: add argument description
  IsDhcpDiscover  - GC_NOTO: add argument description
...
--*/
{
  ...
  if (EFI_ERROR (GetSmbiosSystemGuidAndSerialNumber ((EFI_GUID *) OptEnt.Uuid->Guid, &SystemSerialNumber))) {
    ...
    //
    EfiZeroMem (OptEnt.Uuid->Guid, sizeof (EFI_GUID));
  }
...
Arguments:
  ...
  IpCount - GC_NOTO: add argument description
  SrvList - GC_NOTO: add argument description
  IsDiscv - GC_NOTO: add argument description
  Reply   - GC_NOTO: add argument description
...
--*/
{
  ...
  EfiZeroMem (&Token, sizeof (EFI_DHCP4_TRANSMIT_RECEIVE_TOKEN));

  if (DestIp == NULL) {
    Cport   = PXEBC_DHCP4_C_PORT;
    Sport   = PXEBC_DHCP4_S_PORT;
    IsBCast = TRUE;
  } else {
    Cport   = PXEBC_BS_DISCOVER_PORT;
  ...
  if (IsDiscv) {
    ...
    OptList[OptCount]->Length     = VendorOptLen - 2;
...
Arguments:
  ...
  Length  - GC_NOTO: add argument description
  OptTag  - GC_NOTO: add argument description
...
Arguments:
  ...
  Dhcp4Option   - Pointer to dhcp options
  VendorOption  - Pointer to vendor options

Returns:

  TRUE  : Valid vendor options
  FALSE : Invalid vendor options
...
Arguments:
  ...
  Str - GC_NOTO: add argument description
  Len - GC_NOTO: add argument description
...
Returns:
  ...
  EFI_SUCCESS - GC_NOTO: Add description for return value
  EFI_TIMEOUT - GC_NOTO: Add description for return value
...
--*/
{
  ...
  PromptLen = VendorOpt->MenuPromptLen - 1;
...
--*/
{
  ...
  *Type   = 0;
  ...
  while (MenuSize > 0) {
    ...
    MenuSize          = MenuSize - (MenuItem->DescLen + 3);
