...
--*/
{
  ...
  // Be careful about pad size for alignment
  //
  VarHeader = (VARIABLE_HEADER*) (GetVariableDataPtr (Variable) + \
...
--*/
{
  ...
  EfiInitializeRuntimeDriverLib (ImageHandle, SystemTable,
  ...
  //
  Status = InitializeVariableStore (&mVariableModuleGlobal->VariableBase[Physical].VolatileVariableBase,
  ...
  //
  Status = InitializeVariableStore (&mVariableModuleGlobal->VariableBase[Physical].NonVolatileVariableBase,
