...
STATUS_CODE_LOOKUP_TABLE mClassSubClassToken[] = {
  ...
  { EFI_SOFTWARE_SEC,          "SOFTWARE_EFI_SEC" },
  { EFI_SOFTWARE_PEI_CORE,          "SOFTWARE_EFI_PEI_CORE" },
  { EFI_SOFTWARE_PEI_MODULE,          "SOFTWARE_EFI_PEI_MODULE" },
  { EFI_SOFTWARE_DXE_CORE,          "SOFTWARE_EFI_DXE_CORE" },
  ...
  { EFI_SOFTWARE_RT,          "SOFTWARE_RT" },
  { EFI_SOFTWARE_AL,          "SOFTWARE_AL" },
