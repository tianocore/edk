...
#define EFI_WINNT_RUNTIME_UPDATABLE_OFFSET  \
  (EFI_WINNT_FIRMWARE_OFFSET + EFI_WINNT_FIRMWARE_LENGTH)

#define EFI_WINNT_RUNTIME_UPDATABLE_LENGTH  0x10000


#define EFI_WINNT_FTW_SPARE_BLOCK_OFFSET    \
  (EFI_WINNT_RUNTIME_UPDATABLE_OFFSET + EFI_WINNT_RUNTIME_UPDATABLE_LENGTH)
...
#define EFI_VARIABLE_STORE_OFFSET           \
  (EFI_WINNT_RUNTIME_UPDATABLE_OFFSET + EFI_WINNT_RUNTIME_UPDATABLE_FV_HEADER_LENGTH)
  
#define EFI_VARIABLE_STORE_LENGTH           \
  (0x00C000 - EFI_WINNT_RUNTIME_UPDATABLE_FV_HEADER_LENGTH)

#define EFI_EVENT_LOG_OFFSET              \
  (EFI_VARIABLE_STORE_OFFSET + EFI_VARIABLE_STORE_LENGTH)

#define EFI_EVENT_LOG_LENGTH              0x002000

#define EFI_FTW_WORKING_OFFSET            \
  (EFI_EVENT_LOG_OFFSET + EFI_EVENT_LOG_LENGTH)
