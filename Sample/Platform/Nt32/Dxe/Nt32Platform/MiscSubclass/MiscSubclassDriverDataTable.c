...
//
MISC_SUBCLASS_TABLE_EXTERNS(EFI_MISC_CHASSIS_MANUFACTURER, MiscChassisManufacturer);
MISC_SUBCLASS_TABLE_EXTERNS(EFI_MISC_BIOS_VENDOR, MiscBiosVendor);
MISC_SUBCLASS_TABLE_EXTERNS(EFI_MISC_SYSTEM_MANUFACTURER, MiscSystemManufacturer);
MISC_SUBCLASS_TABLE_EXTERNS(EFI_MISC_BASE_BOARD_MANUFACTURER, MiscBaseBoardManufacturer);
MISC_SUBCLASS_TABLE_EXTERNS(EFI_MISC_PORT_INTERNAL_CONNECTOR_DESIGNATOR, MiscPortInternalConnectorDesignator);
MISC_SUBCLASS_TABLE_EXTERNS(EFI_MISC_PORT_INTERNAL_CONNECTOR_DESIGNATOR, MiscPortKeyboard);
MISC_SUBCLASS_TABLE_EXTERNS(EFI_MISC_PORT_INTERNAL_CONNECTOR_DESIGNATOR, MiscPortMouse);
MISC_SUBCLASS_TABLE_EXTERNS(EFI_MISC_PORT_INTERNAL_CONNECTOR_DESIGNATOR, MiscPortCom1);
MISC_SUBCLASS_TABLE_EXTERNS(EFI_MISC_PORT_INTERNAL_CONNECTOR_DESIGNATOR, MiscPortCom2);
MISC_SUBCLASS_TABLE_EXTERNS(EFI_MISC_SYSTEM_SLOT_DESIGNATION, MiscSystemSlotDesignation);
MISC_SUBCLASS_TABLE_EXTERNS(EFI_MISC_ONBOARD_DEVICE, MiscOnboardDevice);
MISC_SUBCLASS_TABLE_EXTERNS(EFI_MISC_OEM_STRING, OemString);
MISC_SUBCLASS_TABLE_EXTERNS(EFI_MISC_SYSTEM_OPTION_STRING, SystemOptionString);
...
UINTN mMiscSubclassDataTableEntries =
  (sizeof mMiscSubclassDataTable) / sizeof(EFI_MISC_SUBCLASS_DATA_TABLE);
