...
#define   FIRMWARE_BIOS_VERSIONE L"UOL(IA32.UEFI)Alpha: "
#else
#define   FIRMWARE_BIOS_VERSIONE L"UOL(IA32.EFI)Alpha: "
#endif
#else  // EFIX64
#if (EFI_SPECIFICATION_VERSION >= 0x00020000)
#define   FIRMWARE_BIOS_VERSIONE L"UOL(X64.UEFI)Alpha: "
#else
#define   FIRMWARE_BIOS_VERSIONE L"UOL(X64.EFI)Alpha: "
#endif
#endif
