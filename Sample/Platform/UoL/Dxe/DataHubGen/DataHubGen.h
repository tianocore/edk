...
#define   FIRMWARE_PRODUCT_NAME  L"UOL: "

#ifdef EFI32
#if (EFI_SPECIFICATION_VERSION >= 0x00020000)
#define   FIRMWARE_BIOS_VERSIONE L"UOL(IA32.UEFI)Alpha2: "
#else
#define   FIRMWARE_BIOS_VERSIONE L"UOL(IA32.EFI)Alpha2: "
#endif
#else  // EFIX64
#if (EFI_SPECIFICATION_VERSION >= 0x00020000)
#define   FIRMWARE_BIOS_VERSIONE L"UOL(X64.UEFI)Alpha2: "
#else
#define   FIRMWARE_BIOS_VERSIONE L"UOL(X64.EFI)Alpha2: "
#endif
#endif
