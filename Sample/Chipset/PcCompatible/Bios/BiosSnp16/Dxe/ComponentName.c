...
//
EFI_COMPONENT_NAME_PROTOCOL     gBiosSnp16ComponentName = {
  BiosSnp16ComponentNameGetDriverName,
  BiosSnp16ComponentNameGetControllerName,
  "eng"
};

static EFI_UNICODE_STRING_TABLE mBiosSnp16DriverNameTable[] = {
  {
    "eng",
...
--*/
{
  return EfiLibLookupUnicodeString (
          Language,
          gBiosSnp16ComponentName.SupportedLanguages,
