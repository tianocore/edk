...
--*/
{
  ...
  //
  PackageList = PreparePackageList (1, &mUsbKeyboardLayoutPackageGuid, &mUsbKeyboardLayoutBin);
...
--*/
{
  ...
  *KeyChar = 0;
  ...
  while (!IsUSBKeyboardBufferEmpty (UsbKeyboardDevice->KeyboardBuffer)) {
    ...
    //
    // PrintScreen,Pause/Break could not be retrieved via SimpleTxtInEx protocol
    //
