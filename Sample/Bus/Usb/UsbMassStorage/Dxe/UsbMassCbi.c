...
Returns:
  ...
  EFI_SUCCESS          - The CBI protocol is initialized.
...
Returns:
  ...
  EFI_SUCCESS - The command is transferred to device
...
Arguments:
  ...
  TransLen  - The expected transfer length
  Timeout   - The time to wait the command to execute

Returns:

  EFI_SUCCESS - The data transfer succeeded
...
Returns:
  ...
  EFI_DEVICE_ERROR - Failed to execute the command
...
Arguments:
  ...
  Context - The USB CBI device protocol
