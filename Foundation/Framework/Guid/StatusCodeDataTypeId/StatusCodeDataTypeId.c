...
EFI_GUID_STRING(&gEfiStatusCodeDataTypeExceptionHandlerGuid, "Status Code", "Data Hub record Data type Exception handler");

EFI_GUID_STRING(&gEfiStatusCodeSpecificDataGuid, "Status Code Specific Data", "Specific Data for EFI 2.0 ReportStatusCode API");
