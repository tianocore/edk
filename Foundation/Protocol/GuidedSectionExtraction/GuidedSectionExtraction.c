...
Abstract:
  ...
  GUIDed section extraction protocol as defined in the EFI 2.0 File Image 
...
EFI_GUID_STRING(&gEfiSectionExtractionProtocolGuid, "CRC32 GUIDed Section Extraction Protocol", "EFI 2.0 CRC32 GUIDed Section Extraction Protocol");
