...
//
// BugBug: I need to be part of the build and EFI_DRIVER_ENTRY_POINT()
//         needs to be removed from all builds. It only exists for
//         the NT emulation environment.
//
//  The following code could be autogenerated by genmake.
//
//
#ifdef EFI_DEBUG
