...
--*/
{
  ...
  if (!Finished) {
    ...
    //
    StringPackBuffer->Header.Length = (UINT32)(sizeof (EFI_HII_STRING_PACK) - sizeof (EFI_STRING) + sizeof (RELOFST) + sizeof (RELOFST) + EfiStrSize(Language) + EfiStrSize(String));
