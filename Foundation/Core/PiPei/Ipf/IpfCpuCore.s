...
PROCEDURE_ENTRY (SwitchCoreStacks)
        ...
        mov     r9 = in2;;            // this is the parameter2 to pass to the continuation function
        mov     r6 = in3;;              // this is the parameter3 to pass to the continuation function
        dep     r6=0,r6,63,1;;          // zero the bit 63.

        mov     r8 = in4;;              // new stack pointer.
...
// Make PAL call to terminate the CAR status.
        ...
        alloc   r11=0,3,3,0;;           // Set 0-size frame
        mov     loc0 = r5;;
        mov     loc1 = r9;;        
        mov     loc2 = r6;;
...
DoneCARTermination::                                                                    
        ...
        alloc   r11=0,3,3,0 ;;          // alloc  outs going to ensuing DXE IPL service
                                                                                                // on the new stack
        mov     out0 = loc0;;   
        mov     out1 = loc1;;
        mov     out2 = loc2;;
